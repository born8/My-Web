    ...
    return (
        <main>
            <div className={classes.homeContent}>
                ...
                <h2>Hello bro, &nbsp;<span id="name" style={{ color: uiColor }}>{PersonalData.firstName}&nbsp;{PersonalData.lastName}</span></h2>
                <h3 style={{ color: nonThemeColor }}>
                    {PersonalData.nickName}
                </h3>
                <div className={classes.autoText}>
                    Hello, &nbsp; <span id="typer" style={{ color: uiColor }}></span>
                </div>
                <p className={classes.connectText}>Hiya <span style={{ color: uiColor }}>connect</span> with me.</p>
